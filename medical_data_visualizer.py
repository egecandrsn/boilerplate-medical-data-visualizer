...
df['cholesterol'] = df.apply(lambda row: 0 if row['cholesterol'] == 1 else (1 if row['cholesterol'] > 1 else row['cholesterol']), axis=1)
df['gluc'] = df.apply(lambda row: 0 if row['gluc'] == 1 else (1 if row['gluc'] > 1 else row['gluc']), axis=1)
